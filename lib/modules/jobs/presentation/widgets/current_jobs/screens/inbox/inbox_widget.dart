...
class InboxFindJobWidget extends StatelessWidget {
  const InboxFindJobWidget({Key? key}) : super(key: key);
            ...
            children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                ButtonWidget(
                  ...
                  height: 40,
                  onTap: () {
                    Navigator.pushNamed(context, Routes.ProfileDashboardWidget);
                  },
                  title: "Next",
                  buttonColor: AppColors.buttonColor,
                ),
