...
class RemoveEmploymentButton extends StatelessWidget {
  const RemoveEmploymentButton({super.key});
          ...
          Alerts.dialog(context, child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                8.ph,
                const CustomText(
                  "Are you sure you want to remove (Bluefield Net) from your profile? ",
                  fontsize: 13,
                  maxLine: 2,
