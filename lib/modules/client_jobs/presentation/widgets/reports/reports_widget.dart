...
import 'package:bluefieldnet/modules/client_jobs/presentation/widgets/reports/widgets/clearness_is_requested_widget.dart';
import 'package:bluefieldnet/modules/client_jobs/presentation/widgets/reports/widgets/paid_and_cleared.dart';
import 'package:bluefieldnet/modules/client_jobs/presentation/widgets/reports/widgets/paid_not_cleared_widget.dart';
...
class ClientReportsWidget extends StatefulWidget {
  const ClientReportsWidget({Key? key}) : super(key: key);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Expanded(
                        ...
                        child: TabBarView(
                      children: [
                        ClientPaidNotClearedWidget(),
                        ClientClearnessIsRequestedWidget(),
                        ClientPaidAndClearedWidget(),
                      ],
                      controller: tabController,
                    )),
                  ],
